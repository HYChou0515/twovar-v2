...
read -r -a fields <<< "iter t obj decr_rate actsize updsize sucpair sucs_rate nSV nBSV nFree nNonSV PGmax PGmin PGdiff Gmax Gmin Gdiff n_exchange alpha_diff nr_pos_y nr_neg_y"
